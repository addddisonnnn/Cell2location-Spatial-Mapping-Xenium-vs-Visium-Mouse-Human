# Cell2location-Spatial-Mapping-Xenium-vs-Visium-Mouse-Human
Documenting my progress of performing a spatial mapping tool called cell2location on different resolutions, species, and diseases.
...
- [Notebook Descriptions](#notebook-descriptions)
  - [reproduction.ipynb](#reproductionipynb)
...
| 2 | `reproduction.ipynb` | `mousescRNAseq/` and `mouseVisium/` downloaded and extracted | ~25 min (30k iter) |
